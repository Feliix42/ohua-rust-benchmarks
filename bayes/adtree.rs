...
trait AdTreeT {
     ...
     * =============================================================================
     */
    fn getCount(&self, queries: &Vec<Query>) -> usize;
}
                ...
                Some(query) => {
                    ...
                    if (query.value == vary.most_common_value) {
                        ...
                        let super_count = {
                            ...
                            ad_tree.get_count(&super_queries)
                        };
...
impl AdTreeT for AdTree {
    ...
    fn get_count(queries: &Vec<Query>) -> usize {
        let num_query = queries.len();
        ...
        root.get_count(-1, 0, &queries, last_query_index, &ad_tree)
    }
}
