...
use stm::{atomically, det_atomically, dtm, freeze, TVar};

fn main() {
    let matches = App::new("DSTM canneal benchmark")
        .version("1.0")
...
fn run_annealer(
    ...
    for _ in 0..threadcount {
        ...
        let (dtm_sx, dtm_rx) = mpsc::channel();
        ...
        let h = thread::spawn(move || loop {
            ...
            for _ in 0..moves_per_thread {
                // get the new DTM handle
                let dtm_handle = dtm_rx.recv().unwrap();
