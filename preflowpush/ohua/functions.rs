use crate::relabelling::global_relabel_do;
...
impl Graph {
     ...
     */
    pub fn update(&mut self, updates: Vec<(u64, (NodeID, Graph))>) -> (u64, HashSet<NodeID>) {
