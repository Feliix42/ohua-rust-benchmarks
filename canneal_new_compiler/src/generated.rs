...
fn run(
    mut netlist: Netlist,
    worklist: Vec<(MoveDecision, (usize, usize))>,
    temperature: f64,
...
pub fn annealer(
    ...
    let (netlist_0_0_0_0_tx, netlist_0_0_0_0_rx) = std::sync::mpsc::channel();
    ...
    let (worklist_0_0_0_tx, worklist_0_0_0_rx) = std::sync::mpsc::channel::<Vec<(MoveDecision, (usize, usize))>>();
    ...
    let (rs_0_1_1_tx, rs_0_1_1_rx) = std::sync::mpsc::channel::<Vec<(MoveDecision, (usize, usize))>>();
    ...
    let (d_1_0_tx, d_1_0_rx) = std::sync::mpsc::channel::<(MoveDecision, (usize, usize))>();
    ...
    let (rest_0_0_0_tx, rest_0_0_0_rx) = std::sync::mpsc::channel::<Vec<(MoveDecision, (usize, usize))>>();
    let (rs_0_2_0_tx, rs_0_2_0_rx) = std::sync::mpsc::channel::<Vec<(MoveDecision, (usize, usize))>>();
    let (rs_0_0_0_0_tx, rs_0_0_0_0_rx) =
        std::sync::mpsc::channel::<Vec<(MoveDecision, (usize, usize))>>();
    let (netlist_0_0_1_0_tx, netlist_0_0_1_0_rx) = std::sync::mpsc::channel::<Netlist>();
    let (foo_0_0_1_tx, foo_0_0_1_rx) =
        std::sync::mpsc::channel::<Vec<(MoveDecision, (usize, usize))>>();
    let (foo_0_0_0_0_tx, foo_0_0_0_0_rx) =
        std::sync::mpsc::channel::<Vec<(MoveDecision, (usize, usize))>>();
    let (remaining_work_0_0_2_tx, remaining_work_0_0_2_rx) =
        std::sync::mpsc::channel::<Vec<(MoveDecision, (usize, usize))>>();
    ...
    let (rs2_0_0_0_tx, rs2_0_0_0_rx) = std::sync::mpsc::channel::<Vec<(MoveDecision, (usize, usize))>>();
    let (internal_state_0_0_1_tx, internal_state_0_0_1_rx) =
        std::sync::mpsc::channel::<InternalState>();
    let (new_work_0_0_0_tx, new_work_0_0_0_rx) = std::sync::mpsc::channel::<Vec<(MoveDecision, (usize, usize))>>();
    ...
    tasks.push(Box::new(move || -> _ {
        loop {
            let mut var_0 = foo_0_0_1_rx.recv()?;
            let rs2_0_0_0 = var_0.clone();
            rs2_0_0_0_tx.send(rs2_0_0_0)?;
            foo_0_0_0_0_tx.send(var_0)?
        }
    }));
    tasks.push(Box::new(move || -> _ {
        loop {
            let mut var_0 = netlist_0_0_1_0_rx.recv()?;
            let var_1 = rs_0_0_0_0_rx.recv()?;
            let foo_0_0_1 = var_0.update(var_1);
            foo_0_0_1_tx.send(foo_0_0_1)?;
            netlist_0_0_0_0_tx.send(var_0)?
        }
    }));
    tasks.push(Box::new(move || -> _ {
        loop {
    ...
    tasks.push(Box::new(move || -> _ {
        ...
        while keep_going_0_0_0_rx.recv()? {
            let ctrlSig = (true, 1);
            ctrl_0_0_0_tx.send(ctrlSig)?;
            let loop_res_0 = netlist_0_0_0_0_rx.recv()?;
        ...
        let finalResult = netlist_0_0_0_0_rx.recv()?;
